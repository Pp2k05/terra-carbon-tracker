...
export default function TrendsChart() {
  ...
  const totalByCategory = {
    food: data.reduce((sum, d) => sum + d.food, 0),
    transport: data.reduce((sum, d) => sum + d.transport, 0),
    clothing: data.reduce((sum, d) => sum + d.clothing, 0),
    electronics: data.reduce((sum, d) => sum + d.electronics, 0),
  }
